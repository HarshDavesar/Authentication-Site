...
app.use(cors({
    origin: process.env.FRONTEND_URL || 'http://localhost:3000', // Update with your frontend URL in production
    credentials: true,
}));

// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || "mongodb+srv://harshdavesar05:zPZYx2Rlu4bI6Lc9@cluster0.tgioyci.mongodb.net/authApp?retryWrites=true&w=majority&appName=Cluster0")
...
app.post('/save-note', async (req, res) => {
    ...
    try {
        ...
        // Generate JWT token
        const token = jwt.sign({ id: authData._id }, process.env.JWT_SECRET || 'secret.key', { expiresIn: '1h' });
